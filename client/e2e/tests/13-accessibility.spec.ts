...
import { uniqueProjectKey } from '../helpers/test-data';

test.describe('Accessibility Tests', () => {
  test('should have no accessibility violations on project list page', async ({ page }) => {
  ...
  test('should have no accessibility violations on project creation modal', async ({ page }) => {
    const projectView = new ProjectViewPage(page);
    await projectView.goto();
  ...
  test('should have no accessibility violations on proposals page', async ({ page }) => {
  ...
  test('should have keyboard navigation support on project list', async ({ page }) => {
    const projectView = new ProjectViewPage(page);
    await projectView.goto();
    await page.waitForLoadState('networkidle');
